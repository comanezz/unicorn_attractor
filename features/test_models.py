...
class TestFeatureModel(TestCase):
    ...
    def test_title_and_description_is_true(self):
        feature = Feature.objects.create(title="Create a Test", description="Test description")
        feature.save()
        self.assertEqual(feature.title, "Create a Test")
...
class TestCommentModel(TestCase):
    ...
    def test_comment_as_a_string(self):
        ...
        feature = Feature(title="Test feature comment", author=user, description="Test desc")
        feature.save()
        comment = Comment(context="Test Comment", author=user, feature=feature)
